        ...
        public async Task<IActionResult> PropertySingle(string slug, int id)
{
    ...
    {
        ViewBag.roomCount = 0; // veya uygun bir varsayılan değer
        ViewBag.bedCount = 0; // veya uygun bir varsayılan değer
        ViewBag.bathCount = 0; // veya uygun bir varsayılan değer
        ViewBag.size = 0; // veya uygun bir varsayılan değer
        ViewBag.garageCount = 0; // veya uygun bir varsayılan değer
        ViewBag.buildYear = 0; // veya uygun bir varsayılan değer
        ViewBag.location = "Bilinmiyor"; // veya uygun bir varsayılan değer
        ViewBag.videoUrl = "Bilinmiyor"; // veya uygun bir varsayılan değer
    }
